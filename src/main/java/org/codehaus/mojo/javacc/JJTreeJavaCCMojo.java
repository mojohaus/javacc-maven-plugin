    ...
    extends AbstractJavaCCMojo
{
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        // determine output directory of grammar file (*.jj) and node files (*.java) generated by JJTree
        ...
        nodeDirectory = new File( targetDirectory, nodeDirectory.getPath() );
        ...
        try
        {
            ...
            FileUtils.copyDirectory( jjDirectory, nodeDirectory, "*.java", null );
        }
        catch ( Exception e )
        {
        ...
        try
        {
            ...
            FileUtils.copyDirectory( jjtDirectory, parserDirectory, "*.java", null );
        }
        catch ( Exception e )
        {
