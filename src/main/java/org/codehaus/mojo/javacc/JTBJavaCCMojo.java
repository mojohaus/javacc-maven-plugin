    ...
    extends AbstractJavaCCMojo
{
     ...
     * files (<code>*.jj</code>) along with their tree node and visitor files (<code>*.java</code>). The
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        // determine output directory of grammar file (*.jj) generated by JTB
        File jjDirectory = new File( getInterimDirectory(), grammarInfo.getParserDirectory() );

        // determine output directory of tree node files (*.java) generated by JTB
        ...
        // determine output directory of visitor files (*.java) generated by JTB
        ...
        File nodeDir = new File( targetDirectory, nodePackage.replace( '.', File.separatorChar ) );
        try
        {
            getLog().debug( "Copying tree nodes files: " + nodeDirectory + " -> " + nodeDir );
            FileUtils.copyDirectory( nodeDirectory, nodeDir, "*.java", null );
        }
        catch ( Exception e )
        {
        ...
        File visitorDir = new File( targetDirectory, visitorPackage.replace( '.', File.separatorChar ) );
        try
        {
            getLog().debug( "Copying visitor files: " + visitorDirectory + " -> " + visitorDir );
            FileUtils.copyDirectory( visitorDirectory, visitorDir, "*.java", null );
        }
        catch ( Exception e )
        {
        ...
        try
        {
            ...
            FileUtils.copyDirectory( jtbDirectory, parserDirectory, "*.java", null );
        }
        catch ( Exception e )
        {
